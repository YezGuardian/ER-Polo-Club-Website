      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="mb-16">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm font-medium text-muted uppercase tracking-widest">A RIDER'S JOURNEY</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 auto-rows-fr">
          ...
          <ScrollReveal delay={0.4} className="md:col-span-2">
            <div className="min-h-[300px] group relative bg-card border border-cardBorder rounded-3xl overflow-hidden hover:border-foreground/20 transition-all duration-300">
